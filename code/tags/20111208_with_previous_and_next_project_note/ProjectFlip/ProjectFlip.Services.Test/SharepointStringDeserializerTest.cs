...
namespace ProjectFlip.Services.Test
{
    ...
    public class SharepointStringDeserializerTest
    {
        ...
        public void ToListTests()
        {
            ...
            ToListTest("\"test\"", new[] {"test"});
            ToListTest(
                "\"Consulting;#_ Technology Consulting;#__ Technology Consultation;#_ Methodology;#__ Software-Testing;#Development;#_ Software solutions;#__ Bespoke Solutions;#_ Product innovation;#__ Test Engineering\"",
                new[]
                {
                    "Consulting", "Technology Consulting", "Technology Consultation", "Methodology", "Software-Testing",
                    "Development", "Software solutions", "Bespoke Solutions", "Product innovation", "Test Engineering"
                });
            ...
            ToListTest("C++;#LabVIEW;#MS Excel;#UML;#CAD - ProE; MS Visual Studio; SW Analyse Tools; GOOP",
                new[]
                {"C++", "LabVIEW", "MS Excel", "UML", "CAD - ProE", "MS Visual Studio", "SW Analyse Tools", "GOOP"});
            ...
            ToListTest("Review, Wirkungsnetzanalyse, Goldfire", new[] {"Review", "Wirkungsnetzanalyse", "Goldfire"});
