...
///</summary>
    ...
    public class DetailWindowViewModelTest
    {
        ...
        /// <summary>
        ///A test for DetailWindowViewModel Constructor
        ///</summary>
        [TestMethod()]
        ...
        public void NavigateToLeftCommandTest()
        {
            ...
            target.NavigateToLeftCommand.Execute(this);
            Assert.AreSame(target.Document, previousPN.Document);
        }
