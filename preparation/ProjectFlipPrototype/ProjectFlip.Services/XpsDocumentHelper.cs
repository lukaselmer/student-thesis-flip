    ...
    internal class XpsDocumentHelper
    {
        ...
        public BitmapImage Logo()
        {
            ...
            if (doc.FixedDocumentSequenceReader != null)
            {
                ...
                {
                    var images = xpsFixedDocumentReader.FixedPages[1].Images;
                    ...
                    /*var imagex = new List<XpsImage>(images)[new Random().Next(images.Count)];

                    var imagez = new BitmapImage();
                    imagez.BeginInit();
                    imagez.StreamSource = imagex.GetStream();
                    imagez.EndInit();
                    return imagez;*/
                    return DefaultLogo();
                }
